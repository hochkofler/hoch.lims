...
class ProcessesView(ListingView):
    """Folder View for Processes
    """

    def __init__(self, context, request):
        super(ProcessesView, self).__init__(context, request)
        ...
        self.title = self.context.translate(_("Processes"))
